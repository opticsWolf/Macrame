...
- [Release notes](docs/releases) — one document per minor, most recently [v0.17.0](docs/releases/v0.17.0.md) (the comparison cycle: D-274…[D-277](docs/architecture/s13-decision-register.md#d-277), the bulk path's defect and the two opt-in recipes) and [v0.16.0](docs/releases/v0.16.0.md) (the 0.15.0 review, thirty releases and D-243…[D-273](docs/architecture/s13-decision-register.md#d-273)). **The version here is cut and the merge to `main` is not made**: the note precedes the merge, as it has since [D-212](docs/architecture/s13-decision-register.md#d-212), and this line will say so until it does
