...
- [Decision register](docs/architecture/s13-decision-register.md) — D-001…D-272 with rationale
- [Release notes](docs/releases) — one document per minor, most recently [v0.15.0](docs/releases/v0.15.0.md) (branching) and [v0.14.0](docs/releases/v0.14.0.md). [v0.16.0](docs/releases/v0.16.0.md) is **written and not yet released** — the note precedes the merge, as it has since [D-212](docs/architecture/s13-decision-register.md#d-212)
