...
| 19 | 0.16.0 | — | release note before merge; merge | `docs/releases/v0.16.0.md`, `README.md`, `docs/quickref.md`, `docs/architecture/README.md` | §8 read as evidence in the note: seven met, two restated then met, the tenth met late |
