...
**v0.10.0 · A Bitemporal Graph Ledger on libSQL**
...
*Last updated: 2026-08-07 · v0.10.0 · Synced against architecture (s4–s14, appendices A–C) · Pinned by `tests/doc_sync_tests.rs` and `tests/perf_claim_tests.rs`*
